...
class ExportCatalogHelper
{
    ...
    protected function initOffer($obOffer, $obProduct)
    {
        ...
        $arOfferData = [
            'name' => $obOffer->name,
            'rate' => XMLExportSettings::getValue('offers_rate', ''),
            ...
            'auto_discounts' => XMLExportSettings::getValue('field_enable_auto_discounts', false),
    ...
    protected function getOfferImages($obOffer, $obProduct)
    {
        ...
        if (XMLExportSettings::CODE_OFFER == $sCodeModelForImages) {
            $obItem = $obOffer;
        } else {
            $obItem = $obProduct;
        }
        ...
        $bFieldImages = XMLExportSettings::getValue('field_images', false);
    ...
    {
        $bFieldEnableAutoDiscounts = XMLExportSettings::getValue('field_enable_auto_discounts', false);
        $bFieldOldPrice = XMLExportSettings::getValue('field_old_price', false);
